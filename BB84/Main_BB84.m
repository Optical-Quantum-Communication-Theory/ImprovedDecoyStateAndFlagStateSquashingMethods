...
preset='pmBB84WCP_nodecoy'; %no decoy
% preset='pmBB84WCP_decoy'; %decoy
...
%save('Outputs Plots/output_2decoy_Choi.mat','results','parameters');
...
%4.'none': do not plot
plotResults(results,parameters,'km-log')