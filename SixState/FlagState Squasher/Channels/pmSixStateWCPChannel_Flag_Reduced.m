...
function channelModel = pmSixStateWCPChannel_Flag_Reduced(protocolDescription,names,p)
    ...
    [bipartiteExpectationsL,bipartiteExpectationsU] = decoyAnalysis_vec(decoys,bipartiteExpectationsWCP);
