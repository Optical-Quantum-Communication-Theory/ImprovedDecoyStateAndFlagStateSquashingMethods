...
% preset='pmSixStateWCP_decoy_Flag'; %preset with equal intensities

preset='pmSixStateWCP_decoy_Flag_dif_int'; %preset for different
% intensities
...
%save('Outputs/Test_no_bound','results','parameters');
%save('Outputs/output_6state_Flag_dif_int=04436_LP.mat','results','parameters');
